...
%% plotting MOG vs epsilon
% plotting MOG D = 10, N = 100k/800k

load MOG_vs_epsilon_K_5_D_10_N_100k
...
axis([epsilon_all(1)/10 epsilon_all(end)*10 -0.05 1.4])
...
title('MOG (\delta=0.01, N_s = 20k, D = 10, S = 5)','FontSize',FS,'FontWeight','bold')
legend('Non-priv.','capeAGN','conv','local', 'Rand. vect.', 'Location', 'best')

%
load MOG_vs_epsilon_K_5_D_10_N_800k
...
xlabel('Privacy parameter (\epsilon)','FontSize',FS,'FontWeight','bold');
ylabel('q^{comp}','FontSize',FS,'FontWeight','bold');
title('MOG (\delta=0.01, N_s = 160k, D = 10, S = 5)','FontSize',FS,'FontWeight','bold')


% plotting MOG N = 50, D = 100k/800k

load MOG_vs_epsilon_K_10_D_50_N_100k
...
xlabel('Privacy parameter (\epsilon)','FontSize',FS,'FontWeight','bold');
ylabel('q^{comp}','FontSize',FS,'FontWeight','bold');
title('MOG (\delta=0.01, N_s = 20k, D = 50, S = 5)','FontSize',FS,'FontWeight','bold')


%
load MOG_vs_epsilon_K_10_D_50_N_800k
...
xlabel('Privacy parameter (\epsilon)','FontSize',FS,'FontWeight','bold');
ylabel('q^{comp}','FontSize',FS,'FontWeight','bold');
title('MOG (\delta=0.01, N_s = 160k, D = 50, S = 5)','FontSize',FS,'FontWeight','bold')


%% plotting MOG vs samples
% plotting MOG N = 10, eps = 0.5/2
S = 5;
load MOG_vs_samples_K_5_D_10_eps_0_5
...
axis([N_all(1)/(2*S) N_all(end)*2/S -0.05 1.4])
...
ylabel('q^{comp}','FontSize',FS,'FontWeight','bold');
title('MOG (\delta=0.01, \epsilon = 0.5, D = 10, S = 5)','FontSize',FS,'FontWeight','bold')
legend('Non-priv.','capeAGN','conv','local', 'Rand. vect.', 'Location', 'best')

%
load MOG_vs_samples_K_5_D_10_eps_2
...
xlabel('Sample size (N_s)','FontSize',FS,'FontWeight','bold');
ylabel('q^{comp}','FontSize',FS,'FontWeight','bold');
title('MOG (\delta=0.01, \epsilon = 2.0, D = 10, S = 5)','FontSize',FS,'FontWeight','bold')


% plotting MOG N = 50, eps = 1/5

load MOG_vs_samples_K_10_D_50_eps_1
...
xlabel('Sample size (N_s)','FontSize',FS,'FontWeight','bold');
ylabel('q^{comp}','FontSize',FS,'FontWeight','bold');
title('MOG (\delta=0.01, \epsilon = 1.0, D = 50, S = 5)','FontSize',FS,'FontWeight','bold')

%
load MOG_vs_samples_K_10_D_50_eps_5
...
xlabel('Sample size (N_s)','FontSize',FS,'FontWeight','bold');
ylabel('q^{comp}','FontSize',FS,'FontWeight','bold');
title('MOG (\delta=0.01, \epsilon = 5.0, D = 50, S = 5)','FontSize',FS,'FontWeight','bold')
