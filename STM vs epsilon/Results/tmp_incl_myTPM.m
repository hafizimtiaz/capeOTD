...
% errVN_std = std(errVN);
errmyTPM_mean = mean(err_vecmyTPM);
...
semilogx(epsilon_all,errmyTPM_mean,'ms:','LineWidth',3,'MarkerSize',10); hold on
...
legend('Non-private','AGN','AVN','DP-TPM', 'myTPM', 'Random vectors','Location','NE')
...
errmyTPM_mean = myErrMean(err_vecmyTPM);
% errVN_std = std(errVN);
