...
#SBATCH --job-name=stm_22
#SBATCH --output=stm_22.out
#SBATCH --error=stm_22.err
...
mkdir -p $MYTMP                     												
cp $MYHDIR/STM_vs_samples_SYNTH22_combined.m  $MYTMP
...
cp $MYHDIR/STM_data_K_10_D_50_N_50k.mat  $MYTMP
cp $MYHDIR/STM_data_K_10_D_50_N_100k.mat  $MYTMP
cp $MYHDIR/STM_data_K_10_D_50_N_200k.mat  $MYTMP
cp $MYHDIR/STM_data_K_10_D_50_N_500k.mat  $MYTMP
cp $MYHDIR/STM_data_K_10_D_50_N_800k.mat  $MYTMP

cd $MYTMP                           										

matlab -nodisplay -nosplash -r "STM_vs_samples_SYNTH22_combined, exit"
