...
#SBATCH --job-name=mog_22
#SBATCH --output=mog_22.out
#SBATCH --error=mog_22.err
...
mkdir -p $MYTMP                     												
cp $MYHDIR/MOG_vs_samples_SYNTH22_combined.m  $MYTMP
...
matlab -nodisplay -nosplash -r "MOG_vs_samples_SYNTH22_combined, exit"
